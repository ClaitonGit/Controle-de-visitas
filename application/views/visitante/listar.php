    ...
    <div class="content">
            <div class="container-fluid">
                      ...
                      <div class="col-md-3" style="padding-bottom: 10px">
                         <form name="form" action="<?= base_url() ?>Visitante/pesquisar" method="post">
                         <div class="row"> 
                                        <div class="col-md-10">
                                                <input type="text" class="form-control" name="pesquisar" value=""  placeholder="Pesquisa por nome">
                                                </div>
                                                <div class="col-md-1">
                        ...
                        <div class="col-md-3" style="padding-bottom: 10px; left: 80px;">
                         <form name="form" action="<?= base_url() ?>Visitante/pesquisarData" method="post">
                                       <div class="row"> 
                                        <div class="col-md-8">
                                                <input type="date" class="form-control" name="pesquisarData" value=""  >
                                                </div>
                                                <div class="col-md-1">
                                                <button type="submit"  class="btn btn-success " >Pesquisar</button>
                                            </div> 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Histórico visitantes </h4>
                                
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped table-bordered" style="width:100%" id="minhaTabela">
                                    <thead>
                                        <th>Data</th>
                                        <th>Visitante</th>
